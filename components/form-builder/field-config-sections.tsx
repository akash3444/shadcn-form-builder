...
import { PlusIcon, Trash2Icon, XIcon, AlertCircleIcon } from "lucide-react"
import {
  Combobox,
  ComboboxCollection,
  ComboboxContent,
...
export function SwitchRow({
  ...
  return (
    <label className="-mx-2 flex cursor-pointer items-center justify-between rounded-md px-2 py-1.5 transition-colors select-none hover:bg-accent/70">
    ...
    <div className="space-y-2.5">
      ...
      {(field.type === "checkbox-group" ||
        ...
        <MultiSelectCombobox
          ...
          groups={isGrouped(field) ? partitionByGroup(field) : undefined}
          value={(field.defaultValue as string[] | undefined) ?? []}
          onChange={(v) =>
            updateField(field.id, {
            ...
            <div className="flex gap-2">
              ...
              <div className="flex flex-1 flex-col gap-1">
                ...
                <Input
                  ...
                  max={field.maxDate}
                  onChange={(e) =>
                    setRange({ to: e.target.value || undefined })
                  }
                  className="h-7 text-xs"
                />
              </div>
