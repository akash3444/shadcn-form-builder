export interface SlugifyOptions {
  /** String used to join words. Defaults to `"-"`. */
  replacement?: string
  /** Regexp of characters to remove. Defaults to the built-in safe set. */
  remove?: RegExp
  /** Lowercase the result. Defaults to `false`. */
  lower?: boolean
  /** Strip everything but `[A-Za-z0-9]` and whitespace. Defaults to `false`. */
  strict?: boolean
  /** Locale code (e.g. `"de"`) for locale-specific transliteration. */
  locale?: string
  /** Trim leading/trailing replacement chars. Defaults to `true`. */
  trim?: boolean
}
...
interface Slugify {
  (string: string, options?: SlugifyOptions | string): string
  /** Add or override characters in the transliteration map. */
...
slugify.extend = function (customMap: Record<string, string>) {
